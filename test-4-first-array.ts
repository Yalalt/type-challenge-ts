...
// test solve 4 Empty array
type EmptyArrayFirst<T extends any[]> = T extends [] ? never : T[0];
...
type head7 = EmptyArrayFirst<arr4> // expected to be never
type head8 = EmptyArrayFirst<arr3> // expected to be 3
type head9 = EmptyArrayFirst<arr1> // expected to be "a"